    ...
    <div class="container mx-auto px-4 lg:px-8 py-16 lg:py-24 grid lg:grid-cols-2 gap-2 lg:gap-24">
        ...
        <div class="pt-6 lg:pt-0 flex flex-col justify-center">
            ...
            <ul class="text-base lg:text-lg pb-2 lg:pb-4 list-disc pl-4">
                ...
                <li>Productos decorativos, no lúdicos y que sean atractivos por su propia originalidad e incluso puedan integrar la colección de aquellos entusiastas de esa pasión.</li>
            </ul>
            <p class="text-base lg:text-lg">
            El diseño combina la forma con el nombre de cada personaje, dándole su propia característica e identidad y en donde se interviene el cuerpo matriz agregándole elementos que le dan su acabado final.
            </p>
        </div>
    </div>
</section>
    ...
    <div class="container mx-auto px-4 lg:px-8 py-16 lg:py-24 grid lg:grid-cols-2 gap-2 lg:gap-24">
        ...
        <div class="pt-6 lg:pt-0 flex flex-col justify-center">
            ...
            <ul class="text-base lg:text-lg list-disc pl-4">
                ...
                <li>Álbum de 30 páginas con stickers de 48 equipos del Fútbol Argentino y la historia de cada club.</li>
            </ul>
        </div>
    </div>
</section>
