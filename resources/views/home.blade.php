...
@section('main')
    <section id="hero" class="container px-4 lg:px-8 full-hero flex mx-auto flex-col md:flex-row justify-center">
    ...
    <section class="categories grid sm:grid-cols-2 lg:grid-cols-4 text-center">
        <div class="bg-black px-3 py-6 lg:px-8 lg:py-16 flex flex-col justify-between">
            <div>
                <img src="/img/icons/afa.svg" alt="Fútbol Argentino" class="w-12 lg:w-20 mb-5 mx-auto">
        ...
        <div class="bg-beliblue px-3 py-6 lg:px-8 lg:py-16 flex flex-col justify-between">
            <div>
                <img src="/img/icons/premier.svg" alt="British Teams" class="w-12 lg:w-20 mb-5 mx-auto">
                <h3 class="text-2xl tracking-tight font-extrabold text-white pb-5 lg:text-4xl xl:text-5xl lg:pb-10">
                    <span class="block xl:inline">British Teams</span>
                </h3>
            </div>
            <div class="rounded-md">
        ...
        <div class="bg-belired px-3 py-6 lg:px-8 lg:py-16 flex flex-col justify-between">
            <div>
                <img src="/img/icons/world.svg" alt="Qatar 2022" class="w-12 lg:w-20 mb-5 mx-auto">
                <h3 class="text-2xl tracking-tight font-extrabold text-white pb-5 lg:text-4xl xl:text-5xl lg:pb-10">
                    <span class="block xl:inline">Qatar 2022</span>
                </h3>
            </div>
            <div class="rounded-md">
    ...
    <section id="video" class="bg-beliyellow">
        <div class="container mx-auto px-4 lg:px-8 py-16 lg:py-24 grid lg:grid-cols-2 gap-2 lg:gap-24">
            ...
            <div class="pt-6 lg:pt-0 text-black flex flex-col justify-center text-center lg:text-left">
                ...
                <div class="rounded-md">
                    <a href="{{ route('web.about_us') }}" class="inline-block px-4 py-3 uppercase tracking-wider border border-black text-base font-medium rounded-md text-black hover:text-beliyellow bg-transparent hover:bg-black md:py-4 md:text-lg md:px-10 transition ease-in-out hover:scale-110 duration-200">Conocenos mejor</a>
                </div>
            </div>
        </div>
    </section>
